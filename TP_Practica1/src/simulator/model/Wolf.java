...
public class Wolf extends Animal {
	...
	private void update_state(double dt) {
		...
		case NORMAL:
			...
			break;
		case HUNGER:
			if (this.get_hunt_target() == null || (this.get_hunt_target() != null
					&& (this.get_hunt_target().get_state() == State.DEAD || this.get_position()
							.distanceTo(this.get_hunt_target().get_position()) > this.get_sight_range()))) {
